...
#For MC 2017 94X
#python submit_all.py -f DAS_Names_2017_bkg.txt -c topplusdmTrees_cfg.py -p version='94X' -d crab_30Jan --isData



#Special channels:

#For Diboson 2017 94X
#python submit_all.py -f DAS_Names_MET_2017_94X.txt -c topplusdmTrees_cfg.py -p version='94X' -d crab_30Jan --channel="diboson"

#For wprime 2016 94X
#python submit_all.py -f DAS_Names_Wprime.txt -c topplusdmTrees_cfg.py -p version='94X_2016' -d crab_30Jan --channel="diboson"


#Not really necessary to do anything for wzjets and ttbar.
