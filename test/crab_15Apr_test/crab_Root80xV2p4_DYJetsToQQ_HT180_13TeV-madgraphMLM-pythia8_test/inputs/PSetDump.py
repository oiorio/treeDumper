...
process.DMTreesDumper = cms.EDAnalyzer("DMAnalysisTreeMaker",
    ...
    channelInfo = cms.PSet(
        ...
        doTopReweighting = cms.untracked.bool(False),
        doWReweighting = cms.untracked.bool(False),
        getPartonTop = cms.untracked.bool(False),
        getPartonW = cms.untracked.bool(False),
