...
DMTreesDumper.physicsObjects.append(  
    cms.PSet(
        ...
        variablesF = cms.VInputTag(
            ...
            cms.InputTag("muons","muNumberMatchedStations"), ##TAG
            #cms.InputTag("muons","muNumberOfPixelLayers"),
            #cms.InputTag("muons","muNumberOfValidTrackerHits"),
            cms.InputTag("muons","muNumberTrackerLayers"), #TAG
            cms.InputTag("muons","muNumberValidMuonHits"), #TAG
            cms.InputTag("muons","muNumberValidPixelHits"),##TAG
            cms.InputTag("muons","muMiniIso"),##TAG
        ...
        toSave = cms.vstring("muNumberMatchedStations","muNumberOfValidTrackerHits","muNumberMatchedStations","muIsTrackerMuon","muIsGlobalMuon","muMiniIso","muDB","muDBerr","muDz","muDxy",
"muE","muPt","muEta","muPhi","muIso04","muCharge","muIsMediumMuon","muIsTightMuon","muIsLooseMuon","muIsHighPtMuon","allExtra"),
        )
    )
...
#            cms.InputTag(j,jpref+"CMVAv2"),
        ...
        toSave = cms.vstring(jpref+"muonMultiplicity",jpref+"electronMultiplicity",jpref+"MuonEnergy",jpref+"ElectronEnergy",
jpref+"E",jpref+"Pt",jpref+"Eta",jpref+"Phi",jpref+"GenJetE", jpref+"GenJetPhi", jpref+"GenJetPt",jpref+"GenJetEta",jpref+"CSVv2",jpref+"DeepCSV",jpref+"PartonFlavour","allExtra"),
        )
    )
