...
DMTreesDumper.physicsObjects.append( 
    cms.PSet(
        ...
        singleI = cms.VInputTag(),
        singleF = cms.VInputTag(),
        toSave = cms.vstring("jetAK8PuppiGenJetE","jetAK8PuppiGenJetPt","jetAK8PuppiGenJetEta","jetAK8PuppiGenJetPhi","jetAK8PuppiE","jetAK8PuppiPt","jetAK8PuppiEta","jetAK8PuppiPhi", "jetAK8PuppiprunedMass", "jetAK8Puppitau1", "jetAK8Puppitau2", "jetAK8Puppitau3",  "jetAK8PuppiPartonFlavour","jetAK8PuppiHadronFlavour","jetAK8PuppitrimmedMass", "allExtra"),
        )
    )
